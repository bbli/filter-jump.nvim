...
class WindowBufferPair(object):
    ...
    def drawHighlights(self,highlighter):
        ...
        if not highlighter.list_of_highlights:
            return

        # 1. Highlight first
        first_line,first_match = highlighter.current_match
...
# class HighlightStateMachine(object):
